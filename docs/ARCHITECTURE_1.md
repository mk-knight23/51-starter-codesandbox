# 🏗️ Architecture Documentation - CodeSandbox Starter
...
### Purpose
CodeSandbox Starter is designed to Instant dev environment with a focus on simplicity, reliability, and ease of deployment.
